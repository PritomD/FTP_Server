          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                ...
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">User Type</th>
                ...
                <th width="1 0%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Last Name</th>
            ...
            @foreach ($users as $user)
                <tr role="row" class="odd">
                  ...
                  <td>{{ $user->email }}</td>
                  <td class="hidden-xs">{{ $user->usertype }}</td>
            ...
            <tfoot>
              <tr>
                ...
                <th class="hidden-xs" width="20%" rowspan="1" colspan="1">User Type</th>
                <th class="hidden-xs" width="20%" rowspan="1" colspan="1">First Name</th>
                <th class="hidden-xs" width="10%" rowspan="1" colspan="1">Last Name</th>
